...
const Navbar = () => {
  return (
    <div>
      <nav className='w-screen h-24 bg-teal-600 flex items-center px-8 justify-between'>
        ...
        <div className="navMenu flex text-white text-xl font-semibold gap-6 ">
          ...
          <a href="/" className=' ease-in hover:underline-offset-4 hover:text-shadow-md hover:underline'><h3>Browse Skills</h3></a>
          <a href="/" className=' ease-in hover:underline-offset-4 hover:text-shadow-md hover:underline'><h3>How It Works </h3></a>
        ...
        <div className="myAccount flex items-center gap-8 mr-5">
          ...
          <img src={ProfileIcon} alt="" className="w-12 cursor-pointer" />

        </div>
        {/* <div className="logs " >
          <a href="/login"><button className='logButton  text-teal-600 hover:text-black  text-lg mx-2 bg-white  font-bold rounded-lg px-3 py-2 '>Login</button></a>
          <a href="/register"><button className='logButton  text-teal-600 hover:text-black  text-lg mx-2 g-white  font-bold rounded-lg px-3 py-2 '>Get Started</button></a>
        </div> */}
